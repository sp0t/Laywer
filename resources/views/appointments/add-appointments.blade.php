    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-flex justify-content-end align-items-center">
				<a href="/appointments">							
                <button type="submit" class="btn btn-primary ml-3">&lt; &lt; Back to Calendar</button></a>
            </div>
            ...
            <form class="form-validate-jquery" action="#" novalidate="novalidate">
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="basic" class="form-control" required="" placeholder="Enter Location">
                        </div>
                    </div>
                                    <div class="form-group row">
        ...
        <div class="d-flex justify-content-end align-items-center">
            <a href="/">
            <button type="submit" class="btn btn-primary"  style="margin-right: 30px;">Make Appointmnet</button></a>
            <a href="/">
