@extends('layouts.app')
@section('breadcrumb')
<span class="breadcrumb-item active"> Lawyers </span>
@endsection
@section('content')
<div class="content">
    ...
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            ...
            <div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('lawyer.create') }}">							
                    <button type="submit" class="btn btn-primary btn-labeled btn-labeled-left btn-sm"><b><i class="fas fa-plus-circle"></i></b>Add New Lawyer</button>
                </a>
            </div>
        </div>
        ...
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
            <div class="datatable-scroll-wrap">
                <table class="table datatable-basic dataTable no-footer" id="dataTables" role="grid" aria-describedby="DataTables_Table_0_info">
                    <thead>
                        <tr role="row">
                            <th>Id</th>
                            <th>Name</th>
    ...
    $(document).ready(function() {
        ...
        $('#dataTables').DataTable({
            ...
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
                {data: 'contact_no1', name: 'contact_no1'},
