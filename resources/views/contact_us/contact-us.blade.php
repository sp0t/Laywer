...
@section('content')
                ...
                <div class="content">
                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class="datatable-header">
                        ...
                        <thead>
                            <tr role="row">
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First Name: activate to sort column descending">Message ID</th>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="date: activate to sort column ascending" style="">Email</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="date: activate to sort column ascending" style="">Received Date & Time</th>
                        ...
                        <tbody>
                            ...
                            <tr class="odd">
                                ...
                                <td>wasana</td>
                                <td>wasana@gmail.com</td>
                                <td style="">21/12/2022  09:08:03</td>
                                <td><span class="badge badge-danger">Read</span></td>
                                
                                <td>
                                    <div class="list-icons">
                                        <a href="/newcontactus" class="list-icons-item text-teal"><i class="icon-eye"></i></a>
