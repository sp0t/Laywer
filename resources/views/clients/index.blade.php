        ...
        <div class="card-header bg-white header-elements-inline">
            ...
            <div class="d-flex justify-content-end align-items-center">
				<a href="{{ route('client.create'); }}">							
                    <button type="submit" class="btn btn-primary btn-labeled btn-labeled-left btn-sm"><b><i class="fas fa-plus-circle"></i></b>Add New Client</button>
                </a>
            </div>
        </div>
